...
XRegExp =
  ...
  (function (n) {
    ...
    function o(n, r, u) {
      ...
      return (
        u && (f = i.replace.call(f, new RegExp("[" + u + "]+", "g"), "")),
        (n =
          n.xregexp && !n.xregexp.isNative
            ? v(
                t(n.source, f),
                n.xregexp.captureNames ? n.xregexp.captureNames.slice(0) : null
              )
    ...
    function s(n, t) {
      return (
        Object.prototype.toString.call(n).toLowerCase() === "[object " + t + "]"
      );
    }
    function d(n) {
      return (
        ...
        if (
          ...
          if (
            (!ft &&
              r.length > 1 &&
              a(r, "") > -1 &&
              ((e = new RegExp(this.source, i.replace.call(g(this), "g", ""))),
          ...
          s(r, "function")
            ? (f = i.replace.call(String(this), n, function () {
                ...
                return (
                  e &&
                    n.global &&
                    (n.lastIndex = t[t.length - 2] + t[0].length),
                  r.apply(null, t)
                );
              }))
            : ((h = String(this)),
    ...
    for (;;) {
      ...
      if (l) b || ((p = h), (w = s)), ++b;
        ...
        if (
          !--b &&
          (o
            ? (o[0] && p > c && v.push(t(o[0], i.slice(c, p), c, p)),
          ...
          return (
            ...
            c +
              l[o].pattern.replace(i, function (n, t, i) {
                if (t) {
                  if (((e = l[o].names[s - v]), ++s, e)) return "(?<" + e + ">";
